...
{
    [DbContext(typeof(PunContext))]
    partial class PunContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_db.Models.Banner", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Web_db.Models.Brand", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Cart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Coupon", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Message", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("Web_db.Models.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Post", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Postcategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Postcomment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Postsandtag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Posttag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Product", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Productattribute", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Productreview", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Setting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Shipping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Wishlist", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
            ...
            modelBuilder.Entity("Web_db.Models.Cart", b =>
                {
                    b.HasOne("Web_db.Models.Order", "Order")
                        .WithMany("Carts")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("Carts_order_id_foreign")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Web_db.Models.Product", "Product")
                        .WithMany("Carts")
                    ...
                    b.HasOne("Web_db.Models.User", "User")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("Web_db.Models.Category", b =>
                {
                    b.HasOne("Web_db.Models.User", "AddedByNavigation")
                        .WithMany("Categories")
                        .HasForeignKey("AddedBy")
                        .HasConstraintName("Categories_added_by_foreign")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Web_db.Models.Category", "Parent")
            ...
            modelBuilder.Entity("Web_db.Models.Order", b =>
                {
                    b.HasOne("Web_db.Models.Coupon", "Coupon")
                        .WithMany("Orders")
                    ...
                    b.HasOne("Web_db.Models.Shipping", "Shipping")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Web_db.Models.Post", b =>
                {
                    ...
                    b.HasOne("Web_db.Models.Postcategory", "PostCat")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("Web_db.Models.Postcomment", b =>
                {
                    b.HasOne("Web_db.Models.Post", "Post")
            ...
            modelBuilder.Entity("Web_db.Models.Postsandtag", b =>
                {
                    ...
                    b.HasOne("Web_db.Models.Posttag", "Tag")
                        .WithMany("Postsandtags")
                        .HasForeignKey("TagId")
            ...
            modelBuilder.Entity("Web_db.Models.Product", b =>
                {
                    b.HasOne("Web_db.Models.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId")
                        .HasConstraintName("Products_brand_id_foreign")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Web_db.Models.Category", "Cat")
                        .WithMany("ProductCats")
                        .HasForeignKey("CatId")
                        .HasConstraintName("Products_cat_id_foreign")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Web_db.Models.Category", "ChildCat")
            ...
            modelBuilder.Entity("Web_db.Models.Wishlist", b =>
                {
                    b.HasOne("Web_db.Models.Cart", "Cart")
                        .WithMany("Wishlists")
