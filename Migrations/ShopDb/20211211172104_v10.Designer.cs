...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("comestic_csharp.Areas.Identity.Data.ShopUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("comestic_csharp.Models.Orderdetail", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
                    ...
                    b.HasIndex(new[] { "OrderId" }, "Orderdetail_order_id_foreign");

                    b.HasIndex(new[] { "ProductId" }, "Orderdetail_product_id_foreign");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("comestic_csharp.Areas.Identity.Data.ShopUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("comestic_csharp.Models.Cart", b =>
                {
                    ...
                    b.HasOne("comestic_csharp.Areas.Identity.Data.ShopUser", "User")
                        .WithMany("Carts")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("comestic_csharp.Models.Category", b =>
                {
                    b.HasOne("comestic_csharp.Areas.Identity.Data.ShopUser", "AddedByNavigation")
                        .WithMany("Categories")
