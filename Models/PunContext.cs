...
{
    public partial class PunContext : DbContext
    {
        public PunContext()
        {
        }

        public PunContext(DbContextOptions<PunContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseMySQL("server=localhost;user id=root;password=;port=3306;database=punbanhang2;");
            }
        }
